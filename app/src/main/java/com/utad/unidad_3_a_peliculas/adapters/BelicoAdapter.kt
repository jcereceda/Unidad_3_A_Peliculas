...
class BelicoAdapter (private val peliculas: ArrayList<Pelicula>
                    ,val onClick: (Pelicula) -> Unit): RecyclerView.Adapter<BelicoAdapter.ViewHolderBelico>()
{
    inner class ViewHolderBelico(var view: View):RecyclerView.ViewHolder(view){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderBelico {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_block_drama, parent, false)
        return ViewHolderBelico(view)
    }

    override fun onBindViewHolder(holder: ViewHolderBelico, position: Int) {
